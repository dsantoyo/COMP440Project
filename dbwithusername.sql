...
DROP DATABASE IF EXISTS dbwithusername;

CREATE DATABASE dbwithusername;
...
-- INSERT INTO `follows` VALUES ('jsmith','bob'),('batman','catlover'),('doglover','catlover'),('catlover','doglover'),('jsmith','jdoe'),('pacman','matty'),('bob','notbob'),('jdoe','notbob'),('batman','pacman'),('scooby','pacman'),('doglover','scooby'),('pacman','scooby'), ('bob', 'scooby'), ('bob', 'catlover'), ('batman', 'scooby');
